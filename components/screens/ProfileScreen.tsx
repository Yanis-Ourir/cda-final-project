    ...
    <SafeAreaView backgroundColor="#171923" height="100%">
      ...
      <VStack>
        ...
        <Text px="$5" py="$2" color="gray" fontSize="$sm">
          ...
          InnerScreen) in InnerScreen (created by Screen) in Screen (created by
          MaybeScreen) in MaybeScreen (created by BottomTabView)
        </Text>
        <Center>
          <HStack>
          ...
          <HStack alignItems="center">
            ...
            />
            <Icon name="more-horiz" size={40} color="gray" px="$5" />
          </HStack>
        </Center>
      </VStack>
    </SafeAreaView>
